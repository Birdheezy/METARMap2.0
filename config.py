...
SNOWY_ANIMATION_DURATION = 5.0
SNOW_CYCLE_MIN_DURATION = 2.0
SNOW_CYCLE_MAX_DURATION = 4.0
SNOW_START_OFFSET_MAX = 1.0
SNOW_MIN_BRIGHTNESS = 0.05
...
ANIMATION_ORDER = ["WINDY", "LIGHTNING", "SNOWY"]
